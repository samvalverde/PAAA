                      ...
                      <div style={{ marginBottom: "15px" }}>
                        ...
                        <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                          <InputNumber
                            ...
                            onValueChange={(e) => {
                              console.log('User Year GTE filter changed:', e.value, 'Current filters before change:', analyticsForm.filtros);
                              const newFilters = { ...analyticsForm.filtros };
                              ...
                              console.log('User Setting year filters (GTE) - New filters:', newFilters);
                              setAnalyticsForm(prevForm => {
                                const newForm = { ...prevForm, filtros: newFilters };
                                console.log('User SetAnalyticsForm GTE called with:', newForm);
                                return newForm;
                              });
                            }}
                            min={2000}
                          ...
                          <InputNumber
                            ...
                            onValueChange={(e) => {
                              console.log('User Year LTE filter changed:', e.value, 'Current filters before change:', analyticsForm.filtros);
                              const newFilters = { ...analyticsForm.filtros };
                              if (!newFilters['ig02_2_ano_de_graduacion']) {
                                newFilters['ig02_2_ano_de_graduacion'] = {};
                              }
                              ...
                              console.log('User Setting year filters (LTE) - New filters:', newFilters);
                              setAnalyticsForm(prevForm => {
                                const newForm = { ...prevForm, filtros: newFilters };
                                console.log('User SetAnalyticsForm LTE called with:', newForm);
                                return newForm;
                              });
                            }}
                            min={2000}
