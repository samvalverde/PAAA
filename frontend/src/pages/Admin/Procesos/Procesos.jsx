  ...
  const handleCreateProcess = async () => {
    try {
      ...
      const selectedSchool = schools.find(
        (school) => school.value === newProcess.school_id
      );
                ...
                <div className="form-group">
                  ...
                  <div className="form-group" style={{ marginTop: "20px" }}>
                    ...
                    <Dropdown
                      ...
                      onChange={(e) =>
                        setNewProcess({ ...newProcess, school_id: e.value })
                      }
                      options={schools}
                  ...
                  <div className="form-group" style={{ marginTop: "20px" }}>
                    ...
                    <Dropdown
                      ...
                      onChange={(e) =>
                        setNewProcess({ ...newProcess, dataset_type: e.value })
                      }
                  ...
                  <div className="form-group" style={{ marginTop: "20px" }}>
                    ...
                    >
                      El archivo debe llamarse: {newProcess.dataset_type}_
                      {newProcess.version || "VERSION"}.csv o .xlsx
                    </small>
                  </div>
                </div>
